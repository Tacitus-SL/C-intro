...
- [5. Динамическая память](#5-динамическая-память-malloc-calloc-realloc-free)
  - [Что такое malloc?](#51-malloc)
  - [Что такое calloc?](#52-calloc)
  - [Что такое relloc?](#53-relloc)
  - [Что такое free?](#54-free)
- [6. Zombie и Daemon процессы](#6-zombie-и-daemon-процессы)
  - [Что такое Zombie процесс?](#62-zombie)
  - [Что такое Daemon процесс?](#63-daemon)
- [7. Сигналы](#7-сигналы)
- [8. Многопоточность и синхронизация](#8-многопоточность-и-синхронизация)
  - [Что такое Mutex?](#82-mutex)
  - [Что такое Semaphore?](#83-semaphore)
  - [Что такое Condition Variable?](#84-condition-vatiable)
  - [Что такое Barrire?](#85-barrier)
  - [Что такое Atomic operations?](#86-atomic-operations)
- [9. IPC (межпроцессное взаимодействие)](#9-ipc-межпроцессное-взаимодействие)
  - [Что такое Pipes?](91-pipes)
  - [Что такое FIFOs?](#92-named-pipes-fifos)
  - [Что такое Message Queues?](93-message-queues-posix)
  - [Что такое Shared Memory?](94-shared-memory)
  - [Что такое Semaphores v.2?](95-semaphores)
  - [Что такое Signals v.2?](96-signals)
  - [Что такое Unix Domain Sockets?](97-unix-domain-sockets)
  - [Сравнительная таблица](99-сравнительная-таблица)
- [10. IO Multiplexing](#10-io-multiplexing)
  - [Что такое select()?](101-select)
  - [Что такое poll()?](102-poll)
  - [Что такое epoll()?](103-epoll)
- [11. Статические и динамические библиотеки](#11-cтатические-и-динамические-библиотеки)
  - [Что такое Статическая библиотека?](#111-статическая-библиотека)
  - [Что такое Динамическая библиотека?](#112-динамическая-библиотека)
